...
<body>
    <div class="container">
                                                ...
                                                if (isset($_SESSION["MAIL"])) {
                                                    ...
                                                    if ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        if ($ID === '3') {  ?>
                                                            ...
                                                            <li class="li-btn-uprava-sprava">
                                                                <a href="katalog/objednavky.php" class="uprava-btn-sprava">S. objednávok</a>
                                                            </li>
                                                <?php
                                                        }
                                                    }
        ...
        <main>
            <div class="uvodny-obrazok">
                <div class="pozadie-nadpis">Objav <br> nové možnosti</div>
                <img src="/foto/MissingElement.jpg" alt="keramika" class="img-pozadie">
            </div>
            <div class="kategorie-nadpis">
                <h2 class="h2-kategorie">Kategórie</h2>
                <hr>
                <div class="kategorie">
                    <ul>
                        <li class="li-krestanske">
                            <h3>Kresťanský motív</h3>
                            <a href="/katalog/katalog.php" class="krestanske"><img src="/foto/1.jpg" alt="kresťanská potlač" class="krestan-img"></a>
                        </li>
                        <li class="li-folklor">
                            <h3>Folklórny motív</h3>
                            <a href="/katalog/katalog.php"><img src="/foto/2.jpg" alt="folkor clothes" class="folklor-img"></a>
                        </li>
                        <li class="li-keramika">
                            <h3>Keramika</h3>
                            <a href="/katalog/katalog.php"><img src="/foto/3.jpg" alt="keramika" class="keramika-img"></a>
                        </li>
                    </ul>
                </div>
            </div>
