...
<body>
    <div class="container">
        ...
        <main>
            <div>
                <ul class="ul-formular">
                    <li class="li-formular" style="display: inline-block; justify-content:space-between;">
                        <h1 class="formular"><a href="/formulare/vseobecne-podmienky.php" class="a-obchod">Všeobecné podmienky</a></h1>
                    </li>

                    <li>
                        <h1 class="formular"><a href="/formulare/reklamacnyporiadok.php" class="a-obchod">Reklamačný poriadok</a></h1>
                    </li>

                    <li class="li-formular" style="display: inline-block; justify-content:space-between">
                        <h1 class="formular"><a href="/formulare/odstupenie-od-zml.php" class="a-obchod">Odstupenie od zmluvy</a></h1>
                    </li>

                    <li>
                        <h1 class="formular"><a href="/formulare/ochrana-osb-udajov.php" class="a-obchod">Ochrana osobných údajov</a></h1>
                    </li>
                </ul>
                <div style="padding-top: 2%;">
                    <h1>Email: ahoj@gmail.com / CreatorShop@gmail.com </h1>
                    <h1>Tell Č.: 123 456 789 </h1>
                    <h1>Adresa: dk asd asd 130</h1>
